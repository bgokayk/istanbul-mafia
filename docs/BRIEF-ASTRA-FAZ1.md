...
1. IP temizliği — CHARS (satır ~779), boss tanımları, INTRO_LINES, QUESTS/SIDE_QUESTS/ACHS metinleri, tutorial ve diyaloglar. Değişecek adlar: POLAT, MEMATI, CAKIR/ÇAKIR, ABDÜLHEY, DAYI, KEMAL BABA, EŞREF TAKSİCİ, TESTERE NECMİ ve diğer dizi göndermeleri. Yerine özgün mahalle lakapları (öneri, Gökay onaylar: KURT, ÇELİK, USTURA, ZARCI, AMCA, BABA, ŞOFÖR, TESTERE). id alanlarına dokunma (localStorage uyumu), yalnız görünen name/desc/story.
